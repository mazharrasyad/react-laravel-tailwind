...
export const Form = () => {
    ...
    const inputCSS = "block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray placeholder-gray-400 bg-white border border-gray-200 rounded-lg focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
        ...
        <div className="px-8 py-4 pb-8 rounded-lg bg-gray-50">
            <form onSubmit={(e)=>person.data.id?fetchUpdate(e):fetchCreate(e)}>
                ...
                <div className="mt-4">
                    ...
                    />
                    { errorForm.address && <p className="mt-1 text-m text-red-400">This is field is required</p>}
                </div>
